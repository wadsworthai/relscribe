...
| ⬜ | T007 | chore   | 3   | T005, T006, T008 | Publish to PyPI and release 0.1.0 with semrail itself | CI for tests and PR-title lint, trusted-publishing workflow, README usage and migration guide, first self-release. |
| ⬜ | T008 | chore   | 2   | —          | Rename the tool from semrail to verstamp | Package, CLI, config file (verstamp.toml), error prefix, docs, README and agent files; historical task records unchanged. |
