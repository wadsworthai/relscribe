...
| ⬜ | T007 | chore   | 3   | T005, T006, T008, T009 | Add CI, PyPI publishing and uvx-first usage docs        | Tests and PR-title lint in CI, a tag-and-publish workflow with trusted publishing, relscribe.toml for this repo, README usage and migration guide recommending uvx pinned per repo. |
...
| ⬜ | T010 | chore   | 2   | T007       | Release 0.1.0 with relscribe itself | On an up-to-date main run uvx/uv run relscribe release --branch --commit, open the release PR, squash-merge, and confirm CI tags v0.1.0 and publishes it to PyPI (docs/releasing.md). |
