...
| ✅ | T007 | chore   | 3   | T005, T006, T008, T009 | Add CI, release tagging and uvx-first usage docs        | Tests and PR-title lint in CI, a tag-and-publish workflow with trusted publishing, relscribe.toml for this repo, README usage and migration guide recommending uvx pinned per repo. |
